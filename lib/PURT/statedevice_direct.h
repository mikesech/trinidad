...
#ifndef PURT_STATEDEVICE_DIRECT_H
#define PURT_STATEDEVICE_DIRECT_H
...
#ifndef PURT_MODE
#define PURT_MODE PURT_SD_DIRECT
#endif

#if PURT_IS_SD_DIRECT()
/* Start of actual header file */
#include "src/statedevice_common.h"

/* Initialization stuff */
void purt_sd_direct_init_enc(unsigned int enc_baud);
#define purt_sd_direct_init() \
	purt_sd_direct_init_enc((F_CPU +  PURT_STATEDEVICE_BAUD * 8L) / \
...
#else /* !PURT_IS_SD_DIRECT() */
#warning "statedevice_direct.h" has been included even though in other mode.
#endif
